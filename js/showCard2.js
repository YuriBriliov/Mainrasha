class Card {
  constructor(){
    ...
    // this.videoOther = document.querySelector('.bloggers__another_container')
  }
...
// choice_blogger----------------------------------------
  handleCard(elem, idCard){
    ...
    let videoContainer = document.querySelector('.blogger__video_container')
    let videoOther = document.querySelector('.bloggers__another_container')
    let card_content = '';
    ...
    if (this.card_id === idCard) {
      ...
      videoOther.outerHTML = ''
      console.log(this.videoContainer)
      console.log(this.videoOther)
      console.log(block)
    }else{
      CATALOG.forEach(({ id }) => {
        if (idCard === id) {
    ...
    `;
      videoContainer.innerHTML = vidoeContainerMain
